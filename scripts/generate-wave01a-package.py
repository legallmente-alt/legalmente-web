...
(ROOT / 'current-state.json').write_text(json.dumps({cid: {
    ...
    'social_composition_state': 'REVIEW_REQUIRED',
    'media_url_state': 'TEMPORARY_VALIDATION_URL',
    'current_integration_state': 'PUBLIC_INTEGRATION_APPROVED' if cid == 'LM-PC-013' else 'SEMANTIC_BINDING_RESOLVED_INTEGRATION_NOT_APPROVED',
    ...
    'next_gate': 'Integration QA for the educational route; separate publication decision' if cid == 'LM-PC-013' else 'Separate integration decision; no public route or publication',
