...
units = {
    ...
    'LM-PC-031': {
        ...
        'route': '/proceso/organizar-hechos-y-prueba',
        'previous': 'Describir los hechos: quién trabaja, bajo qué organización y qué está documentado.',
        'next': 'Ordenar funciones, lugar, jornada, salario, pagos y vacaciones sin convertir la lista en una conclusión individual. El proceso existente funciona como estructura de aprendizaje y navegación, no como fuente laboral.',
