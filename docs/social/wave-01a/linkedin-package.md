...
Función: educación, autoridad editorial, conocimiento, fuentes y contexto. Formato visual: 1080 × 1350, 4:5. No engagement bait, asesoría ni promesas.

### LM-PC-013 — Antes de discutir consecuencias, nombra el objeto
...
**LINKEDIN_SOURCE_NOTE:** Fuente: Código Civil Federal, arts. 1794 y 1824. Territorio: México — explicación educativa; no regla panhispánica. No determina la validez, nulidad, exigibilidad ni efecto de un contrato concreto.
**LINKEDIN_CTA:** Guarda esta pregunta para la próxima revisión documental.
**LINKEDIN_ALT_TEXT:** Bodegón cálido sobre una mesa de madera: una caja de cartón con etiqueta en blanco y una regla metálica; a la derecha hay una estructura de varillas y en primer plano una bandeja con cinta y un recipiente oscuro.
**LINKEDIN_VISUAL_4X5:** `assets/LM-PC-013_feed_4x5.png`
**ASSET_ID:** `LM-PC-013_feed_4x5`

### LM-PC-031 — Describir una relación de trabajo sin saltar a la conclusión
...
**LINKEDIN_SOURCE_NOTE:** Fuente: Ley Federal del Trabajo, arts. 20–21 y 25. Territorio: México — explicación educativa; no regla panhispánica. No etiqueta una relación concreta ni calcula derechos o prestaciones.
**LINKEDIN_CTA:** Usa la lista como mapa de revisión, no como conclusión automática.
**LINKEDIN_ALT_TEXT:** Bodegón cálido sobre una mesa de madera: una caja de herramientas con herramientas y un mazo; un delantal de tela cuelga al fondo, junto a una etiqueta de cartón con cordón, un recipiente oscuro y cuadernos con un bolígrafo.
**LINKEDIN_VISUAL_4X5:** `assets/LM-PC-031_feed_4x5.png`
**ASSET_ID:** `LM-PC-031_feed_4x5`

### LM-PC-065 — Clasificación y documento no son la misma pregunta
...
**LINKEDIN_SOURCE_NOTE:** Fuente: Ley General de Sociedades Mercantiles, arts. 1 y 6. Territorio: México — explicación educativa; no regla panhispánica. No identifica ni valida una entidad concreta ni confirma que un documento esté completo o vigente.
**LINKEDIN_CTA:** Convierte cada capa en una pregunta separada antes de revisar conclusiones.
**LINKEDIN_ALT_TEXT:** Bodegón cálido sobre una mesa de madera: tres soportes de madera con piezas de distintas texturas, una carpeta de cartón cerrada, una placa metálica, un recipiente oscuro sobre una base de piedra y una bandeja con cinta.
**LINKEDIN_VISUAL_4X5:** `assets/LM-PC-065_feed_4x5.png`
**ASSET_ID:** `LM-PC-065_feed_4x5`

## Cuenta Founder — cola separada

La cola Founder no copia el canal institucional. Su función es criterio profesional, autoridad corporativa, reflexión jurídica y riesgo empresarial; no se publica todavía.
